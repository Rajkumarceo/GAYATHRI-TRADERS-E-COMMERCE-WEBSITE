...
export default function Footer() {
  return (
    <footer className="bg-[#1A472A] text-white pt-16 pb-8 border-t border-[#11301c]">
          ...
          <div>
            ...
            <div className="space-y-6 text-sm text-gray-300">
              <div>
                ...
                <p>ATTUR, SALEM</p>
                <p>Marine Drive</p>
                <p>GAYATHRI TRADERS</p>
                <p className="flex items-center mt-1"><Phone className="w-3 h-3 mr-2"/> +91 8270691757</p>
              </div>
              <div>
                <h5 className="font-bold text-white mb-2 flex items-center"><MapPin className="w-4 h-4 mr-2 text-yellow-400"/> UAE Hubs</h5>
                <p>THIRUVANAMALI</p>
                <p> GAYATHRI TRADERS ONLINE </p>
                <p className="flex items-center mt-1"><Phone className="w-3 h-3 mr-2"/> +91 8270691757 </p>
              </div>
            </div>
          </div>
      ...
      {/* Floating WhatsApp */}
      <a href="https://wa.me/918270691757" target="_blank" rel="noreferrer" className="fixed bottom-6 right-6 bg-green-500 text-white p-4 rounded-full shadow-2xl hover:scale-110 transition-transform z-50 flex items-center justify-center">
